...
export default function Empresa() {
  return (
   <>
   <div className='p-4'>
    <h1 className='text-2xl font-extrabold font-sans'>EMPRESA</h1>
    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/2 md:w-full">
        <div class="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Registrar Empresas</h2>
            <p class="leading-relaxed text-base">Texto</p>
      ...
      <div class="p-4 lg:w-1/2 md:w-full">
        <div class="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Listas de Empresas</h2>
            <p class="leading-relaxed text-base">Texto</p>
            <Button className='bg-[#2F9B86]' >
